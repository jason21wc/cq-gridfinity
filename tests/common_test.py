...
SKIP_TEST_LID = "SKIP_TEST_LID" in env
SKIP_TEST_CUTOUT = "SKIP_TEST_CUTOUT" in env
SKIP_TEST_ITEMHOLDER = "SKIP_TEST_ITEMHOLDER" in env
SKIP_TEST_TRAY = "SKIP_TEST_TRAY" in env
SKIP_TEST_DRAWER = "SKIP_TEST_DRAWER" in env

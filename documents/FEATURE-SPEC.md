...
| 1E.5 | Stacking latches | `rugged-box/rugged-box-library.scad` | `_stacking_latch_shape()` (~2079), `_stacking_latch_part()`, `_box_stacking_latch_ribs()` | P3 | Verified | Side-mounted. `catch_offset` -10mm, `grip_length` 8mm, `screw_separation` 20mm. Requires box height >40mm. Stacking gap 1.6mm (GF stackable) |
